...
tsv=128
isv=32
PYTHONPATH=.. python training/minimal_monai_torchio_example.py --parallel True --model pvt --sv_w ${size} --sv_h ${size} --sv_d ${size} --train_subvolumes ${tsv} --infer_subvolumes ${isv} --n_epochs 200 --train_path ./data/afedorov_T1_c_atlas_data/dataset_train_limited.csv --validation_path ./data/afedorov_T1_c_atlas_data/dataset_valid_limited.csv --inference_path ./data/afedorov_T1_c_atlas_data/dataset_infer_limited.csv --n_classes 104 --logdir ../vit3d_results/
