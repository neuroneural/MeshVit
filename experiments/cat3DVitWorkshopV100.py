...
if __name__ == "__main__":
    ...
    try:
        ...
        customEpochMetricsCallback = CustomEpochMetricsCallback( "macro_dice", 64, args.patch_size, args.n_layers, args.d_model, args.d_ff, args.n_heads, args.d_encoder, modelsize)
        ...
        runner.train(
            ...
            logdir=logdir,
            verbose=True,
            callbacks=[customEpochMetricsCallback]
        )
        completed = True
        ...
        print("finally")
        if not completed:
            CustomEpochMetricsCallback.log_hyperparams(64, args.patch_size, args.n_layers, args.d_model, args.d_ff, args.n_heads, args.d_encoder, .0005, "NA", False, "Not Completed","NA")
