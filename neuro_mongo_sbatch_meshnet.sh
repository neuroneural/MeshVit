...
sv=38
ps=19
PYTHONPATH=.. python training/minimal_mongo.py --parallel True --model meshnet --n_epochs 10 --n_classes 3 --logdir ../vit3d_results/ --train_subvolumes ${tsv} --patch_size ${ps} --sv_h ${sv}  --sv_w ${sv} --sv_d ${sv}